...
def detect_human(net, ln, frame, encoder, tracker, time):
    ...
    with open(csv1_filename, mode='a', newline='') as csvfile:
        csvwriter = csv.writer(csvfile)
        csvwriter.writerow(["c1", counter])  # Append the counter value
...
def main(video_path):
    ...
    with open(csv1_filename, mode='w', newline='') as csvfile:
        csvwriter = csv.writer(csvfile)
